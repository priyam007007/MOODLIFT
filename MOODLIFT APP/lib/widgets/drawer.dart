...
class MyDrawer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final imageUrl = "https://critpath.org/wp-content/uploads/sites/6/2019/12/Mental-Health-2.jpg";
    return Drawer(
          ...
          children: [
            DrawerHeader(
              ...
              child: UserAccountsDrawerHeader(
               ...
               accountName: Text("MOODLIFT"),
               accountEmail: Text("the.team.smc.t.3@gmail.com"),
